		...
		<AnimatePresence>
			{isActive && (
				<motion.div
					...
					className="absolute bottom-0 left-0 right-0 z-50 bg-background border-t border-border rounded-3xl p-4 pb-[calc(var(--safe-area-inset-bottom)+1rem)] flex flex-col gap-4"
				>
					{steps.length > 0 && (
						<>
